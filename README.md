...
> Scrape Google SERP results: titles, URLs, snippets, and related searches. Use when agents need SEO research, competitor tracking, SERP analysis, or web research without API keys.
...
```
Install the ""Google Search Scraper"" skill from Claw0x
```

Or use this connection prompt:

```
Add skill: google-search-scraper
Platform: Claw0x
...
2. Add to your agent's configuration:
   - Skill name: `google-search-scraper`
...
```bash
npx @claw0x/cli add google-search-scraper
```
...
Scrape Google search results page. Returns titles, URLs, snippets, and related searches. No Google API key needed.
...
**GitHub**: [github.com/kennyzir/google-search-scraper](https://github.com/kennyzir/google-search-scraper)
...
- [Skill Documentation](https://claw0x.com/skills/google-search-scraper)
